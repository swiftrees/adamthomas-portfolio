const Intro = () => {
  return (
    <div>
      <p>
        Adaptable software developer with almost 7 years of industry experience,
        specialising in medical software solutions. Capable of delivering
        high-quality software across desktop and web platforms with expertise
        ...
        passion for creating impactful software solutions. With the confidence
        to complete any task set before me, I am eager to bring my diverse skill
        set and innovative mindset to new challenges.
      </p>
    </div>
  );
};
